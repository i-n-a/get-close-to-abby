...
//     Same code as in the previous test (but without the test files), because there is already client validation in there. Need to see later if backend validation can be done, how it will be done, and if it is needed or not.


//     Database Write Test:
//     Is the user-submitted ticket information saved correctly into the database?
